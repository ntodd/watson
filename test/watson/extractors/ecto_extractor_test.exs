defmodule Watson.Extractors.EctoExtractorTest do
  use ExUnit.Case, async: true

  alias Watson.Extractors.EctoExtractor

  setup do
    tmp_dir = System.tmp_dir!() |> Path.join("watson_ecto_test_#{:rand.uniform(10000)}")
