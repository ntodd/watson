defmodule Exint.Extractors.PhoenixExtractorTest do
  use ExUnit.Case, async: true

  alias Exint.Extractors.PhoenixExtractor

  setup do
    tmp_dir = System.tmp_dir!() |> Path.join("exint_phx_test_#{:rand.uniform(10000)}")
