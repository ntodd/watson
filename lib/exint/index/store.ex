defmodule Exint.Index.Store do
  @moduledoc """
  Handles reading and writing of index files.

  The index is stored as:
  - `.exint/manifest.json` - Index metadata
  - `.exint/index.jsonl` - JSON Lines format records
  - `.exint/cache/` - Cache directory for compiled data
  """

  alias Exint.Records.Record
